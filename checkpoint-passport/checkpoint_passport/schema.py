...
# Which tool/agent generated the passport.
@dataclass
class GeneratedBy:
    tool: Optional[str] = None                    # e.g. "hpc-checkpoint-passport"
    version: Optional[str] = None
    agent: Optional[str] = None                   # agent identity if generated by an AI agent
...
class ModelPassport:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> ModelPassport:
        ...
        return cls(
            ...
            generated_by=_dict_to_dataclass(GeneratedBy, data.get("generated_by")),
...
def _dataclass_to_dict(obj: Any) -> Dict[str, Any]:
    """asdict that prunes None at the top level for cleaner JSON.

    We don't recursively prune; callers can keep meaningful explicit nulls
    deeper in the tree (e.g. `auxiliary_outputs.reward_head: null`).
    """
